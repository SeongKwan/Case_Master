...
class DrugListItemStore {
    ...
    @computed get drugs() {
        ...
        return this._sorting(this._searchForCase(this.searchKeywordForCase, this.registry));
    }
    ...
    // 증례용
    @observable searchKeywordForCase = ''; //사용자가 검색창에 검색한 키워드
    @action setSearchKeywordForCase = (searchKeyword) => { this.searchKeywordForCase = searchKeyword; }

    _searchForCase = (searchKeyword, items) => {
